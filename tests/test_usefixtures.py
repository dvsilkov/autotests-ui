...
# используем фикстуру fill_books_database
@pytest.mark.usefixtures('fill_books_database')
def test_read_all_books_in_library():
    pass

# используем фикстуры clear_books_database' и 'fill_books_database'
...
# команда для запуска python -m pytest -s -v -k "test_read_all_books_in_library or TestLibrary"