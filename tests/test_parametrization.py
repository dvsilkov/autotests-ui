...
def test_numbers(number: int):
    assert number > 0
# command to run - python -m pytest -k "test_numbers" -s -v
...
# command to run - python -m pytest -k "test_several_numbers" -s -v
...
# command to run - python -m pytest -k "test_multiplication_of_numbers" -s -v
...
# command to run - python -m pytest -k "test_open_browser" -s -v
...
# command to run - python -m pytest -k "TestOperations" -s -v
