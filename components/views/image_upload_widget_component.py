"""
Это один компонент, который изменяет внешний вид в зависимости от того, выбрано изображение или нет. Когда изображение
не выбрано, отображается EmptyViewComponent, который был рассмотрен ранее. Как только пользователь загружает
изображение, по локатору data-testid элемента картинки (create-course-preview-image-upload-widget-preview-image)
становится понятно, что этот элемент относится к компоненту ImageUploadWidget.
"""
...
class ImageUploadWidgetComponent(BaseComponent):
    """
    Класс описывает элементы в компоненте ImageUploadWidgetComponent (виджет для загрузки изображения)
    ...
    def __init__(self, page: Page, identifier: str):
        ...
        # локаторы для ImageUploadWidgetComponent
