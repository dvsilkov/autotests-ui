...
class DashboardPage(BasePage):
    def __init__(self, page: Page):
        ...
        # Добавляем компоненты Navbar и Sidebar
        self.navbar = NavbarComponent(page)
        self.sidebar = SidebarComponent(page)


        # локаторы страницы DashboardPage
    ...
    def check_visible_dashboard_title(self, title_text):
        """ Метод для проверки заголовка на Dashboard"""
        expect(self.dashboard_title).to_be_visible()
        expect(self.dashboard_title).to_have_text(title_text)

    def check_visible_students_chart(self):
        """ Метод проверяет наличие графика со студентами и заголовок графика """
    ...
    def check_visible_scores_chart(self):
        """ Метод проверяет наличие графика с оценками """
